...
router.get('/singlecourse/:courseId', passport.authenticate("jwt.authors",{session:false}), controllerC.findOne);
...
router.put('/update/:courseId', passport.authenticate("jwt.authors",{session:false}), checkLogout, controllerC.update);

router.delete('/delete/:courseId', passport.authenticate("jwt.authors",{session:false}), checkLogout, controllerC.destroy);
